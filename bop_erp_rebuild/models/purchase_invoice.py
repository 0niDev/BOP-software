...
class PurchaseInvoiceLine(BaseModel):
    """Individual line item in a purchase invoice"""
...
class PurchaseInvoice(BaseModel):
    ...
    def add_line(self, item_id: int, item_name: str, item_code: str,
                 ...
                 warehouse_name: str = "", batch_number: str = "",
                 tax_rate: float = 0.0, discount_percent: float = 0.0,
        ...
        line = PurchaseInvoiceLine(
            purchase_invoice_id=self.id or 0,
            item_id=item_id,
            item_name=item_name,
            item_code=item_code,
            quantity=quantity,
